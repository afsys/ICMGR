...
//\  them as well.
//   $Revision: 1.1.1.1 $                $Date: 2005/01/18 01:55:40 $
//\/////
//\mini
...
////////
if (typeof ol_fgcolor=='undefined') var ol_fgcolor="#FFFFD0";
...
function overlib() {
	...
	if (olNs4) {
		...
		overShld = o3_frame.document.layers['overDivShld'];
	} else if (document.all) {
		over = o3_frame.document.all['overDiv'];
		overShld = o3_frame.document.all['overDivShld'];
	} else if (document.getElementById) {
		over = o3_frame.document.getElementById("overDiv");
		overShld = o3_frame.document.getElementById("overDivShld");
	}
...
function createPopup(lyrContent){
	...
	if (o3_wrap && !(olNs4 || olOp)) {
		if (olIe4) {
			...
			var _offs = over.offsetHeight;

			repositionTo(over, 0, -_offs);
			repositionTo(overShld, 0, -_offs);
		}
	}
...
function placeLayer() {
	...
	repositionTo(overShld, placeX, placeY);
}
...
function showObject(obj) {
	...
	if (is_ie) {
		overShld.style.width = over.scrollWidth + 'px';
		overShld.style.height = over.scrollHeight + 'px';
		overShld.style.visibility = 'visible';
	}
...
function hideObject(obj) {
	...
	overShld.style.visibility = 'hidden';
