...
FCKConfig.ToolbarSets["Accessibility"] = [
	['Source','-','Cut','Copy','Paste','-','SelectAll','RemoveFormat','-','Link','Unlink','-','Image','Rule','-','About','SpellCheck'] ,
	['Style','-','Bold','Italic','Underline','-','OrderedList','UnorderedList','-','Undo','Redo']
];
...
FCKConfig.ToolbarSets["OHD"] = [
	['Source','-','Bold','Italic','Underline','-','OrderedList','UnorderedList','-','SpellCheck','-','Undo','Redo']
];
